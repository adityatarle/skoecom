...
<footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © heuristictechnopark.com 2025</span>
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Free <a href="https://heuristictechnopark.com/" target="_blank">Bootstrap admin templates from heuristictechnopark.com</a></span>
          </div>
        </footer>
        <!-- partial -->
      </div>
